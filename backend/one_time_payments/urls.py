...
urlpatterns = [
    ...
    path('campaigns/<int:pk>/requests/export/', views.CampaignRequestsExportView.as_view(), name='campaign-requests-export'),
    path('campaigns/<int:pk>/requests/approve-all/', views.CampaignApprovePendingRequestsView.as_view(), name='campaign-approve-pending'),
