...
exec gunicorn --chdir backend stimul_ico.wsgi:application --bind 0.0.0.0:${PORT:-8000} --workers ${GUNICORN_WORKERS:-3} --timeout 120 --keep-alive 2 --max-requests 1000 --max-requests-jitter 100
